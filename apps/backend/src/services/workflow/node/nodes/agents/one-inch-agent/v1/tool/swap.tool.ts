 ...
 */
export const createOneInchSwapTool: AgentToolFactory<OneInchToolsContext> = (
  options,
) => {
  return tool({
    name: "oneinch_swap_tool" satisfies ToolNames,
    description: "Swap tokens on 1Inch (OneInch) DEX.",
    parameters: quotationArgsSchema.extend({
